...
(function (global, factory) {
	...
	Link.prototype = {
		...
		shineColor: 0x808080, // THREE.Color( shineColor ) or THREE.Color( shineColer.r, shineColer.g, shineColer.b )
	...
	const domEvent = {
		...
		// 全てのグローバルな設定を変更する。
		setGlobalLinkConfig:
			function (newTab, shineOnMouse = 'OFF', shineOnTouch = 'ON', shineColor = 0xCCCCCC) {
